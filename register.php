  ...
  <body>
    <div class="page login-page">
          ...
          <div class="row">
            ...
            <div class="col-lg-6 bg-white">
              <div class="form d-flex align-items-center">
                <div class="content">
                  <form class="form-validate" action="fun/register.php" method="post">
                    <div class="form-group">
                      <input id="register-id" type="text" name="registerNationalID" required data-msg="Please enter your id" class="input-material">
                      <label for="register-id" class="label-material">National ID</label>
                    </div>
                    <div class="form-group">
      ...
      <div class="copyrights text-center">
        <p>Design by <a href="login.php" class="external">SP</a>
